		...
		<div style="  width: 1100px;  margin: auto;">
			<div style="float: right;">
				...
				if(!isset($_SESSION["steamid"])) {
					...
					echo "<a class=\"btns\">Login with </a>";
			...
			<div id="main">
				<div class="sidebar">
					<nav id="nav">
						<h2>Menu</h2>
						<ul>
							<li><a href="/"><i class="fa fa-play" style="padding-right: 15px;"></i>Play</a></li>
							<li><a href="/history"><i class="fa fa-history" style="padding-right: 15px;"></i>Game History</a></li>
							<li><a href="/top"><i class="fa fa-star" style="padding-right: 15px;"></i>Top Players</a></li>
							<li><a href="/about"><i class="fa fa-book" style="padding-right: 15px;"></i>About our site</a></li>
							<li><a href="http://vk.com/csgo_stf"><i class="fa fa-envelope-o" style="padding-right: 15px;"></i>Support</a></li>
						</ul>
					</nav>
					<?php 
					if(isset($_SESSION["steamid"])) {
					...
					<nav id="nav">
						<h2>Personal Menu</h2>
						<ul>
							<li><a href="./settings.php"><i class="fa fa-cogs" style="padding-right: 15px;"></i>Settings</a></li>
							<li><a href="steamauth/logout.php"><i class="fa fa-sign-out" style="padding-right: 15px;"></i>Logout</a></li>
						</ul>
					</nav>
					<?php } ?>
					...
					<div class="last-winner">
						...
						<ul>
							<li>
								<span class="val">Won:</span>
								<span class="price">$<?php echo round($winnercost,2); ?></span>
							</li>
							<li>
								<span class="val">Chance:</span>
				...
				<header class='head'>
					...
					<div class="jackpot">		
						<p>Participate in the current jackpot by depositing skins! <br>Min. bet $ 3, maximum 15 items 
The higher the rate, the greater chance to win.</p>
					</div>
					<div class="items">
							<ul>
								<li>
						...
						<h3 style="text-align: left;">Game: <?php echo $lastgame; ?></h3>
						<div class="game">
						<div class="progress">
							<div class="stuffs promo-cover">Join in!</div>
							<div class="visual">
								<div class="progressb">
						...
						<div class="rate">
							<div class="count" style="margin-right: 270px;padding: 15px 20px;">
								<div class="chance rcol" style="float: right;font-size: 17px;width: 150px;margin-top: 10px;">
									<p style="font: 500 25px/25px 'Roboto', sans-serif;  margin: 0;  width: 110px;  float: left;  color: #474747;">Chance</p>
						...
						if(!isset($_SESSION["steamid"])) echo '<div id="add_game"><a class="btwn_game" href="?login">'.$msg[$lang]["ingame"].'!</a></div>';
							...
							if(strlen($token) < 2) echo '<div id="add_game"><a class="btwn_game" href="#" onclick="alert2(\'You must set your Trade URL!\')">'.$msg[$lang]["ingame"].'!</a></div>';
